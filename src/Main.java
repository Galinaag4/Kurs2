...
public class Main {
    ...
    private static void addTask(Scanner scanner){
     ...
     switch (typeTask){
         case 0:
             schedule.add(new Task(name, taskDescription, task_type, dateTime));
             break;
         case 1:
             schedule.add(new Daily(name, taskDescription, task_type, dateTime));
             break;
         case 2:
             schedule.add(new Weekly(name, taskDescription, task_type, dateTime));
             break;
         case 3:
             schedule.add(new Monthly(name, taskDescription, task_type, dateTime));
             break;
         case 4:
             schedule.add(new Annual(name, taskDescription, task_type, dateTime));
             break;
         default:
